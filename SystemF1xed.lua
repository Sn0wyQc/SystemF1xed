if game.CoreGui:FindFirstChild("SysBroker") then
    game.CoreGui.SysBroker:Destroy()
end
...
local function ToggleNoclip(bool)
    ...
    if bool then
        ...
        SendNotify("System Broken", "Noclip activado", 3)
    else
        local char = plr.Character
        if char then
            for _, part in ipairs(char:GetDescendants()) do
        ...
        SendNotify("System Broken", "Noclip desactivado", 3)
    end
end
...
local function ToggleFling(bool)
    flingEnabled = bool
    if bool then
        SendNotify("System Broken", "Fling activado - Gira rápidamente para flingear", 3)
    else
        SendNotify("System Broken", "Fling desactivado", 3)
    end
end
...
local function GiveTpTool()
    ...
    SendNotify("System Broken", "Herramienta de TP añadida al inventario", 3)
end
...
local Extras_Section_Button = Instance.new("TextButton")
...
local UnboxedAnim_Button = Instance.new("TextButton")
local WickedDancingAnim_Button = Instance.new("TextButton")
local WickedPopularAnim_Button = Instance.new("TextButton")
local CatwalkAnim_Button = Instance.new("TextButton")
local SportsAnim_Button = Instance.new("TextButton")
local CommunityAnim_Button = Instance.new("TextButton")
...
--NEWS
local Extras_Section = Instance.new("ScrollingFrame")
local Explode_Button = Instance.new("TextButton")
local FaceZ_Button = Instance.new("TextButton")
local FreakyHand_Button = Instance.new("TextButton")
local BallRoll_Button = Instance.new("TextButton")
...
Background.BorderColor3 = Color3.fromRGB(0, 179, 42)
Background.Position = UDim2.new(0.5, 0, 0.5, 0)
Background.Size = UDim2.new(0, 500, 0, 350)
Background.ZIndex = 9
Background.Image = "rbxassetid://159991693"
Background.ImageColor3 = Color3.fromRGB(0, 179, 42)
...
TitleBarLabel.Text = "____/SYSTEMF1XED\\___"
TitleBarLabel.TextColor3 = Color3.fromRGB(0, 179, 42)
...
Home_Section_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
Character_Section_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
Character_Section_Button.Position = UDim2.new(0, 0, 0, 65)
...
Target_Section_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
Target_Section_Button.Position = UDim2.new(0, 0, 0, 105)
...
Animations_Section_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
Animations_Section_Button.Position = UDim2.new(0, 0, 0, 145)
...
Extras_Section_Button.Name = "Extras_Section_Button"
Extras_Section_Button.Parent = SectionList
Extras_Section_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
Extras_Section_Button.BackgroundTransparency = 0.500
Extras_Section_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
Extras_Section_Button.BorderSizePixel = 0
Extras_Section_Button.Position = UDim2.new(0, 0, 0, 185)
Extras_Section_Button.Size = UDim2.new(0, 105, 0, 30)
Extras_Section_Button.Font = Enum.Font.Oswald
Extras_Section_Button.Text = "Extras"
Extras_Section_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
Extras_Section_Button.TextScaled = true
Extras_Section_Button.TextSize = 14.000
Extras_Section_Button.TextWrapped = true

Credits_Section_Button.Name = "Credits_Section_Button"
Credits_Section_Button.Parent = SectionList
Credits_Section_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
Credits_Section_Button.Position = UDim2.new(0, 0, 0, 225)
...
Welcome_Label.TextColor3 = Color3.fromRGB(0, 179, 42)
...
Announce_Label.Text = loadstring(game:HttpGet("https://raw.githubusercontent.com/Sn0wyQc/SystemF1xed/refs/heads/main/announce"))()
Announce_Label.TextColor3 = Color3.fromRGB(0, 179, 42)
...
WalkSpeed_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
WalkSpeed_Input.BorderColor3 = Color3.fromRGB(0, 179, 42)
...
ClearCheckpoint_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
JumpPower_Input.BorderColor3 = Color3.fromRGB(0, 179, 42)
...
JumpPower_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
SaveCheckpoint_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
Respawn_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
FlySpeed_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
FlySpeed_Input.BorderColor3 = Color3.fromRGB(0, 179, 42)
...
Fly_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
NoclipToggle.Parent = Character_Section
NoclipToggle.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
NoclipToggle.BackgroundTransparency = 0.500
NoclipToggle.BorderColor3 = Color3.fromRGB(0, 0, 0)
NoclipToggle.BorderSizePixel = 0
NoclipToggle.Position = UDim2.new(0, 25, 0, 275)
NoclipToggle.Size = UDim2.new(0, 150, 0, 30)
NoclipToggle.Font = Enum.Font.Oswald
...
NoclipToggle.TextWrapped = true

TpToolButton.Name = "TpToolButton"
TpToolButton.Parent = Character_Section
TpToolButton.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
TpToolButton.BackgroundTransparency = 0.500
TpToolButton.BorderColor3 = Color3.fromRGB(0, 0, 0)
TpToolButton.BorderSizePixel = 0
TpToolButton.Position = UDim2.new(0, 25, 0, 325)
TpToolButton.Size = UDim2.new(0, 150, 0, 30)
TpToolButton.Font = Enum.Font.Oswald
...
TpToolButton.TextWrapped = true

FlingToggle.Name = "FlingToggle"
FlingToggle.Parent = Character_Section
FlingToggle.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
FlingToggle.BackgroundTransparency = 0.500
FlingToggle.BorderColor3 = Color3.fromRGB(0, 0, 0)
FlingToggle.BorderSizePixel = 0
FlingToggle.Position = UDim2.new(0, 210, 0, 275)
FlingToggle.Size = UDim2.new(0, 150, 0, 30)
FlingToggle.Font = Enum.Font.Oswald
FlingToggle.Text = "Fling"
FlingToggle.TextColor3 = Color3.fromRGB(0, 0, 0)
FlingToggle.TextScaled = true
FlingToggle.TextSize = 14.000
FlingToggle.TextWrapped = true
...
TargetImage.BorderColor3 = Color3.fromRGB(0, 179, 42)
...
TargetName_Input.BorderColor3 = Color3.fromRGB(0, 179, 42)
...
UserIDTargetLabel.TextColor3 = Color3.fromRGB(0, 179, 42)
...
ViewTarget_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
FlingTarget_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
FocusTarget_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
BenxTarget_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
PushTarget_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
WhitelistTarget_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
TeleportTarget_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
HeadsitTarget_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
StandTarget_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
BackpackTarget_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
DoggyTarget_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
DragTarget_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
Animations_Section.CanvasSize = UDim2.new(0, 0, 2.2, 0)  -- Cambia de 1.6 a 2.2
...
VampireAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
HeroAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
ZombieClassicAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
MageAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
GhostAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
ElderAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
LevitationAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
AstronautAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
NinjaAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
WerewolfAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
CartoonAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
PirateAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
SneakyAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
ToyAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
KnightAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
ConfidentAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
PopstarAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
PrincessAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
CowboyAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
PatrolAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
ZombieFEAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
-- NUEVOS BOTONES DE ANIMACIONES
UnboxedAnim_Button.Name = "UnboxedAnim_Button"
UnboxedAnim_Button.Parent = Animations_Section
UnboxedAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
UnboxedAnim_Button.BackgroundTransparency = 0.500
UnboxedAnim_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
UnboxedAnim_Button.BorderSizePixel = 0
UnboxedAnim_Button.Position = UDim2.new(0, 210, 0, 525)
UnboxedAnim_Button.Size = UDim2.new(0, 150, 0, 30)
UnboxedAnim_Button.Font = Enum.Font.Oswald
UnboxedAnim_Button.Text = "Unboxed"
UnboxedAnim_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
UnboxedAnim_Button.TextScaled = true
UnboxedAnim_Button.TextSize = 14.000
UnboxedAnim_Button.TextWrapped = true

WickedDancingAnim_Button.Name = "WickedDancingAnim_Button"
WickedDancingAnim_Button.Parent = Animations_Section
WickedDancingAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
WickedDancingAnim_Button.BackgroundTransparency = 0.500
WickedDancingAnim_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
WickedDancingAnim_Button.BorderSizePixel = 0
WickedDancingAnim_Button.Position = UDim2.new(0, 25, 0, 575)
WickedDancingAnim_Button.Size = UDim2.new(0, 150, 0, 30)
WickedDancingAnim_Button.Font = Enum.Font.Oswald
WickedDancingAnim_Button.Text = "Wicked Dancing"
WickedDancingAnim_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
WickedDancingAnim_Button.TextScaled = true
WickedDancingAnim_Button.TextSize = 14.000
WickedDancingAnim_Button.TextWrapped = true

WickedPopularAnim_Button.Name = "WickedPopularAnim_Button"
WickedPopularAnim_Button.Parent = Animations_Section
WickedPopularAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
WickedPopularAnim_Button.BackgroundTransparency = 0.500
WickedPopularAnim_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
WickedPopularAnim_Button.BorderSizePixel = 0
WickedPopularAnim_Button.Position = UDim2.new(0, 210, 0, 575)
WickedPopularAnim_Button.Size = UDim2.new(0, 150, 0, 30)
WickedPopularAnim_Button.Font = Enum.Font.Oswald
WickedPopularAnim_Button.Text = "Wicked Popular"
WickedPopularAnim_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
WickedPopularAnim_Button.TextScaled = true
WickedPopularAnim_Button.TextSize = 14.000
WickedPopularAnim_Button.TextWrapped = true

CatwalkAnim_Button.Name = "CatwalkAnim_Button"
CatwalkAnim_Button.Parent = Animations_Section
CatwalkAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
CatwalkAnim_Button.BackgroundTransparency = 0.500
CatwalkAnim_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
CatwalkAnim_Button.BorderSizePixel = 0
CatwalkAnim_Button.Position = UDim2.new(0, 25, 0, 625)
CatwalkAnim_Button.Size = UDim2.new(0, 150, 0, 30)
CatwalkAnim_Button.Font = Enum.Font.Oswald
CatwalkAnim_Button.Text = "Catwalk"
CatwalkAnim_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
CatwalkAnim_Button.TextScaled = true
CatwalkAnim_Button.TextSize = 14.000
CatwalkAnim_Button.TextWrapped = true

SportsAnim_Button.Name = "SportsAnim_Button"
SportsAnim_Button.Parent = Animations_Section
SportsAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
SportsAnim_Button.BackgroundTransparency = 0.500
SportsAnim_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
SportsAnim_Button.BorderSizePixel = 0
SportsAnim_Button.Position = UDim2.new(0, 210, 0, 625)
SportsAnim_Button.Size = UDim2.new(0, 150, 0, 30)
SportsAnim_Button.Font = Enum.Font.Oswald
SportsAnim_Button.Text = "Sports"
SportsAnim_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
SportsAnim_Button.TextScaled = true
SportsAnim_Button.TextSize = 14.000
SportsAnim_Button.TextWrapped = true

CommunityAnim_Button.Name = "CommunityAnim_Button"
CommunityAnim_Button.Parent = Animations_Section
CommunityAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
CommunityAnim_Button.BackgroundTransparency = 0.500
CommunityAnim_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
CommunityAnim_Button.BorderSizePixel = 0
CommunityAnim_Button.Position = UDim2.new(0, 25, 0, 675)
CommunityAnim_Button.Size = UDim2.new(0, 150, 0, 30)
CommunityAnim_Button.Font = Enum.Font.Oswald
CommunityAnim_Button.Text = "Community"
CommunityAnim_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
CommunityAnim_Button.TextScaled = true
CommunityAnim_Button.TextSize = 14.000
CommunityAnim_Button.TextWrapped = true

NoBoundariesAnim_Button.Name = "NoBoundariesAnim_Button"
NoBoundariesAnim_Button.Parent = Animations_Section
NoBoundariesAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
NoBoundariesAnim_Button.BackgroundTransparency = 0.500
NoBoundariesAnim_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
NoBoundariesAnim_Button.BorderSizePixel = 0
NoBoundariesAnim_Button.Position = UDim2.new(0, 210, 0, 675)
NoBoundariesAnim_Button.Size = UDim2.new(0, 150, 0, 30)
NoBoundariesAnim_Button.Font = Enum.Font.Oswald
NoBoundariesAnim_Button.Text = "No Boundaries"
NoBoundariesAnim_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
NoBoundariesAnim_Button.TextScaled = true
NoBoundariesAnim_Button.TextSize = 14.000
NoBoundariesAnim_Button.TextWrapped = true

BoldAnim_Button.Name = "BoldAnim_Button"
BoldAnim_Button.Parent = Animations_Section
BoldAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
BoldAnim_Button.Position = UDim2.new(0, 25, 0, 725)
...
StylishAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
StylishAnim_Button.Position = UDim2.new(0, 210, 0, 725)
...
BubblyAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
BubblyAnim_Button.Position = UDim2.new(0, 25, 0, 775)
...
NFLAnim_Button.Name = "NFLAnim_Button"
NFLAnim_Button.Parent = Animations_Section
NFLAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
NFLAnim_Button.BackgroundTransparency = 0.500
NFLAnim_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
NFLAnim_Button.BorderSizePixel = 0
NFLAnim_Button.Position = UDim2.new(0, 210, 0, 775)
NFLAnim_Button.Size = UDim2.new(0, 150, 0, 30)
NFLAnim_Button.Font = Enum.Font.Oswald
NFLAnim_Button.Text = "NFL"
NFLAnim_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
NFLAnim_Button.TextScaled = true
NFLAnim_Button.TextSize = 14.000
NFLAnim_Button.TextWrapped = true

Extras_Section.Name = "Extras_Section"
Extras_Section.Parent = Background
Extras_Section.Active = true
Extras_Section.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
Extras_Section.BackgroundTransparency = 1.000
Extras_Section.BorderColor3 = Color3.fromRGB(0, 0, 0)
Extras_Section.BorderSizePixel = 0
Extras_Section.Position = UDim2.new(0, 105, 0, 30)
Extras_Section.Size = UDim2.new(0, 395, 0, 320)
Extras_Section.Visible = false
Extras_Section.CanvasSize = UDim2.new(0, 0, 1.5, 0)
Extras_Section.ScrollBarThickness = 5

Explode_Button.Name = "Explode_Button"
Explode_Button.Parent = Extras_Section
Explode_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
...
Explode_Button.Position = UDim2.new(0, 25, 0, 25)
...
FaceZ_Button.Name = "FaceZ_Button"
FaceZ_Button.Parent = Extras_Section
FaceZ_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
FaceZ_Button.BackgroundTransparency = 0.500
FaceZ_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
FaceZ_Button.BorderSizePixel = 0
FaceZ_Button.Position = UDim2.new(0, 210, 0, 25)
FaceZ_Button.Size = UDim2.new(0, 150, 0, 30)
FaceZ_Button.Font = Enum.Font.Oswald
FaceZ_Button.Text = "Face [Z]"
FaceZ_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
FaceZ_Button.TextScaled = true
FaceZ_Button.TextSize = 14.000
FaceZ_Button.TextWrapped = true

FreakyHand_Button.Name = "FreakyHand_Button"
FreakyHand_Button.Parent = Extras_Section
FreakyHand_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
FreakyHand_Button.BackgroundTransparency = 0.500
FreakyHand_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
FreakyHand_Button.BorderSizePixel = 0
FreakyHand_Button.Position = UDim2.new(0, 25, 0, 75)
FreakyHand_Button.Size = UDim2.new(0, 150, 0, 30)
FreakyHand_Button.Font = Enum.Font.Oswald
FreakyHand_Button.Text = "Freaky Hand"
FreakyHand_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
FreakyHand_Button.TextScaled = true
FreakyHand_Button.TextSize = 14.000
FreakyHand_Button.TextWrapped = true

BallRoll_Button.Name = "BallRoll_Button"
BallRoll_Button.Parent = Extras_Section
BallRoll_Button.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
BallRoll_Button.BackgroundTransparency = 0.500
BallRoll_Button.BorderColor3 = Color3.fromRGB(0, 0, 0)
BallRoll_Button.BorderSizePixel = 0
BallRoll_Button.Position = UDim2.new(0, 210, 0, 75)
BallRoll_Button.Size = UDim2.new(0, 150, 0, 30)
BallRoll_Button.Font = Enum.Font.Oswald
BallRoll_Button.Text = "Ball Roll"
BallRoll_Button.TextColor3 = Color3.fromRGB(0, 0, 0)
BallRoll_Button.TextScaled = true
BallRoll_Button.TextSize = 14.000
BallRoll_Button.TextWrapped = true

EmotesButton.Name = "EmotesButton"
EmotesButton.Parent = Extras_Section
EmotesButton.BackgroundColor3 = Color3.fromRGB(0, 179, 42)
EmotesButton.BackgroundTransparency = 0.500
EmotesButton.BorderColor3 = Color3.fromRGB(0, 0, 0)
EmotesButton.BorderSizePixel = 0
EmotesButton.Position = UDim2.new(0, 25, 0, 125)
EmotesButton.Size = UDim2.new(0, 150, 0, 30)
EmotesButton.Font = Enum.Font.Oswald
EmotesButton.Text = "Emotes"
EmotesButton.TextColor3 = Color3.fromRGB(0, 0, 0)
EmotesButton.TextScaled = true
EmotesButton.TextSize = 14.000
EmotesButton.TextWrapped = true
...
Credits_Label.Text = "Made by: MalwareHUB \nRemastered by: Esnowitowo\nDiscord: Esnowitowo"
Credits_Label.TextColor3 = Color3.fromRGB(0, 179, 42)
...
Crown.ImageColor3 = Color3.fromRGB(0, 179, 42)
...
UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(30, 30, 30)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 179, 42))}
...
OpenClose.ImageColor3 = Color3.fromRGB(0, 179, 42)
...
CreateClicker(UnboxedAnim_Button)
CreateClicker(WickedDancingAnim_Button)
CreateClicker(WickedPopularAnim_Button)
CreateClicker(CatwalkAnim_Button)
CreateClicker(SportsAnim_Button)
CreateClicker(CommunityAnim_Button)
CreateClicker(NoBoundariesAnim_Button)
CreateClicker(BoldAnim_Button)
CreateClicker(StylishAnim_Button)
CreateClicker(BubblyAnim_Button)
CreateClicker(NFLAnim_Button)

CreateClicker(Explode_Button)
CreateClicker(FaceZ_Button)
CreateClicker(FreakyHand_Button)
CreateClicker(BallRoll_Button)
CreateClicker(EmotesButton)

CreateToggle(NoclipToggle)
CreateToggle(FlingToggle)
CreateClicker(TpToolButton)
...
Extras_Section_Button.MouseButton1Click:Connect(function()
	ChangeSection(Extras_Section_Button)
end)
...
NoclipToggle.MouseButton1Click:Connect(function()
    ChangeToggleColor(NoclipToggle)
    ToggleNoclip(NoclipToggle.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0))
end)

FlingToggle.MouseButton1Click:Connect(function()
    ChangeToggleColor(FlingToggle)
    ToggleFling(FlingToggle.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0))
end)
...
-- Añadir conexión para noclip en RenderStepped
RunService.RenderStepped:Connect(function()
    ...
    if flingEnabled and plr.Character then
        local root = plr.Character:FindFirstChild("HumanoidRootPart")
        if root and root.Velocity.Magnitude > 50 then
            -- Aplicar fuerza de fling cuando el jugador se mueve rápidamente
            root.Velocity = root.Velocity * 1.2
        end
    end
end)
...
EmotesButton.MouseButton1Click:Connect(function()
    SendNotify("System Broken", "Cargando Emotes...", 3)
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Sn0wyQc/SnowEmotes/refs/heads/main/EmotePlayer%20Snow.lua"))()
end)
...
UnboxedAnim_Button.MouseButton1Click:Connect(function()
	local Animate = plr.Character.Animate
	Animate.Disabled = true
	StopAnim()
	Animate.idle.Animation1.AnimationId = "http://www.roblox.com/asset/?id=98281136301627"
	Animate.idle.Animation2.AnimationId = "http://www.roblox.com/asset/?id=138183121662404"
	Animate.walk.WalkAnim.AnimationId = "http://www.roblox.com/asset/?id=90478085024465"
	Animate.run.RunAnim.AnimationId = "http://www.roblox.com/asset/?id=134824450619865"
	Animate.jump.JumpAnim.AnimationId = "http://www.roblox.com/asset/?id=121454505477205"
	Animate.climb.ClimbAnim.AnimationId = "http://www.roblox.com/asset/?id=121145883950231"
	Animate.fall.FallAnim.AnimationId = "http://www.roblox.com/asset/?id=94788218468396"
	plr.Character.Humanoid:ChangeState(3)
	Animate.Disabled = false
end)

WickedDancingAnim_Button.MouseButton1Click:Connect(function()
	local Animate = plr.Character.Animate
	Animate.Disabled = true
	StopAnim()
	Animate.idle.Animation1.AnimationId = "http://www.roblox.com/asset/?id=92849173543269"
	Animate.idle.Animation2.AnimationId = "http://www.roblox.com/asset/?id=132238900951109"
	Animate.walk.WalkAnim.AnimationId = "http://www.roblox.com/asset/?id=73718308412641"
	Animate.run.RunAnim.AnimationId = "http://www.roblox.com/asset/?id=135515454877967"
	Animate.jump.JumpAnim.AnimationId = "http://www.roblox.com/asset/?id=78508480717326"
	Animate.climb.ClimbAnim.AnimationId = "http://www.roblox.com/asset/?id=129447497744818"
	Animate.fall.FallAnim.AnimationId = "http://www.roblox.com/asset/?id=78147885297412"
	plr.Character.Humanoid:ChangeState(3)
	Animate.Disabled = false
end)

WickedPopularAnim_Button.MouseButton1Click:Connect(function()
	local Animate = plr.Character.Animate
	Animate.Disabled = true
	StopAnim()
...
CatwalkAnim_Button.MouseButton1Click:Connect(function()
	local Animate = plr.Character.Animate
	Animate.Disabled = true
	StopAnim()
...
SportsAnim_Button.MouseButton1Click:Connect(function()
	local Animate = plr.Character.Animate
	Animate.Disabled = true
	StopAnim()
...
CommunityAnim_Button.MouseButton1Click:Connect(function()
	local Animate = plr.Character.Animate
	Animate.Disabled = true
	StopAnim()
...
NoBoundariesAnim_Button.MouseButton1Click:Connect(function()
	local Animate = plr.Character.Animate
	Animate.Disabled = true
	StopAnim()
...
NFLAnim_Button.MouseButton1Click:Connect(function()
	local Animate = plr.Character.Animate
	Animate.Disabled = true
	StopAnim()
...
FaceZ_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/platinum-ViniVX/mic-up-script-pack/refs/heads/main/facef*ck"))()
end)

FreakyHand_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet("https://pastefy.app/YZoglOyJ/raw"))()
end)

BallRoll_Button.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet("https://pastebin.com/raw/jH29gJSZ"))()
end)
